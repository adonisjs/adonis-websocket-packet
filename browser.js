...
fns.eventPacket = function (topic, body) {
  if (!body || (typeof body === 'undefined' ? 'undefined' : _typeof(body)) !== 'object' || !body.event || !body.data) {
    throw new Error('event body must have event and data property');
  }
  return makePacket(codes.EVENT, { topic: topic, body: body }, ['topic']);
};
...
module.exports = Object.assign({ codes: codes }, fns);
